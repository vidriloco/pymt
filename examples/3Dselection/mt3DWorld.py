...
class MT3DWorld(MTWidget):
    ...
    #	objects = OBJ(filename).get_objects()
    #	list = []
    #	for obj in objects:
    #		threeDobj = Reactive3DObject(obj, self.count)
    #		self.count+=1
    #		list.append(threeDobj)
    #	self.models[filename.split('.')[0]] = list
...
if __name__ == '__main__':
	...
	objects = OBJ("monkey.obj").get_objects()
	list = []
	...
	for obj in objects:
		...
		threeDobj = Reactive3DObject(obj, world.number())
		list.append(threeDobj)
